...
<head>
    ...
    <title>Tambah Data Profil - Admin</title>
...
<body class="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-slate-800">➕ Tambah Data Profil Baru</h1>
            <p class="text-slate-500 mt-2">Isi formulir di bawah untuk menambahkan data profil baru</p>
        </div>
            ...
            <form action="{{ route('admin.profil.save') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="isi_konten" id="isi_konten" required
                        ...
                        placeholder="Tulis isi konten di sini...">{{ old('isi_konten') }}</textarea>
                    @error('isi_konten')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex gap-4 pt-6 border-t border-slate-200">
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition flex-1">
                        <i class="fas fa-save mr-2"></i> Simpan Data Profil
                    </button>
