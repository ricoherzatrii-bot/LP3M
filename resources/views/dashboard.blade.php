            ...
            <nav class="flex-1 overflow-y-auto px-5 py-6 space-y-1 relative z-10">
                ...
                <div class="mb-1">
                    ...
                    <div id="menuProfil" class="hidden overflow-hidden pl-4 pr-4 py-2 space-y-0.5 text-[12px] text-white border-l-2 border-white/40 ml-8 mt-1 mb-3">
                        ...
                        <a onclick="loadPage('Pengumuman')" class="submenu-item block py-2.5 px-3 flex items-center space-x-3 cursor-pointer"><i class="fas fa-bullhorn opacity-40 text-[10px] w-3"></i> <span>📢 Pengumuman</span></a>
                    </div>
                </div>
                ...
                <div class="mb-1">
                    ...
                    <div id="menuCapaian" class="hidden overflow-hidden pl-4 pr-4 py-2 space-y-0.5 text-[12px] text-white border-l-2 border-white/40 ml-8 mt-1 mb-3">
                        ...
                        <a onclick="loadPage('Laporan AMI')" class="submenu-item block py-2.5 px-3 flex items-center space-x-3 cursor-pointer"><i class="fas fa-file-invoice opacity-40 text-[10px] w-3 text-center"></i> <span>Laporan AMI</span></a>
                        <a onclick="loadPage('RTM')" class="submenu-item block py-2.5 px-3 flex items-center space-x-3 cursor-pointer"><i class="fas fa-handshake opacity-40 text-[10px] w-3 text-center"></i> <span>RTM</span></a>
                        <div class="mt-2 mb-2">
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            ...
                            ticks: { font: { family: 'Arial', size: 11, weight: 'bold' }, color: '#94a3b8' }
                        },
                        x: {
