    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-16">
        <div class="grid lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-2">
                <h1 class="text-4xl font-bold text-white mb-10 font-serif-luxury">Artikel</h1>

                <div class="space-y-0">
                    @foreach($kategoris as $kat)
                    <a href="{{ route('artikel.kategori', $kat['slug']) }}" 
                       class="flex items-center justify-between py-5 border-b border-white/10 group hover:bg-slate-800/30 px-4 -mx-4 rounded-xl transition-all">
                        <span class="text-blue-400 font-semibold text-lg group-hover:text-blue-300 transition">{{ $kat['nama'] }}</span>
