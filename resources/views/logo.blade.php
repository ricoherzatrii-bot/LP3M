...
<div class="p-6 flex items-center space-x-4 border-b border-blue-800">
    ...
    <div class="flex flex-col">
        <h1 class="font-extrabold text-[15px] leading-tight text-white tracking-wide uppercase">
            LPM POLJAM
        </h1>
        <p class="text-[10px] text-blue-300 font-bold tracking-widest uppercase opacity-80">
            ADMINISTRATOR
        </p>
    </div>
</div>