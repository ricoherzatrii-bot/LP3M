            ...
            <nav class="flex-1 overflow-y-auto px-5 py-6 space-y-1 relative z-10">
                ...
                <div class="mb-1">
                    ...
                    <div id="menuCapaian" class="hidden overflow-hidden pl-4 pr-4 py-2 space-y-0.5 text-[12px] text-white border-l-2 border-white/40 ml-8 mt-1 mb-3">
                        ...
                        <button type="button" onclick="loadPilarRenstraPanel()" class="submenu-item w-full text-left py-2.5 px-3 flex items-center space-x-3 cursor-pointer"><i class="fas fa-columns opacity-40 text-[10px] w-3"></i> <span>Pilar Renstra</span></button>
