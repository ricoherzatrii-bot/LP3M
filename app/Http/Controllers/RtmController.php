...
class RtmController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $path       = $file->storeAs('rtm', $namaFile, 'public');
            ...
            $dokumen = Rtm::create([
                ...
                'ukuran_file'=> $ukuran,
                'tipe_file'  => $ekstensi,
                'kategori'   => $request->kategori ?? 'RTM',
                'slug'       => Str::slug($request->judul),
            ]);

            return response()->json([
                'success' => true,
                'message' => 'RTM "' . $request->judul . '" berhasil diupload!',
                'data'    => [
                    'id'          => $dokumen->id,
                    'judul'       => $dokumen->judul,
                    'tahun'       => $dokumen->tahun,
            ...
            \Log::error('Upload RTM Gagal: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            \Log::error('Update RTM Gagal: ' . $e->getMessage());
            return response()->json([
                'success' => false,
                'message' => 'Terjadi kesalahan sistem: ' . $e->getMessage()
            ], 500);
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'RTM "' . $judul . '" berhasil dihapus!',
        ]);
    }
